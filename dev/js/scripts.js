...
function fineAnimation(){
  ...
  tl.from("#fine-logo",{duration:1, scale:3});
  return tl;
}
...
//   });
//   tl.from("#fine", { x: 650, duration: 1, scale: 2 });
//   tl.to("#fine", { x: 0, duration: 1, scale: 1 });
//   return tl;
// }
...
//   var tl = gsap.timeline({
//     defaults: { duration: 3, ease: 'power2.inOut', stagger: 0.5 }, scrollTrigger: {
//       trigger: "#wataru", pin: true, scrub: 0.3, start: "top 150%", end: "-=-2600", markers: false
//     }
//   });
...
//   var tl = gsap.timeline({
//     defaults: { duration: 3, ease: 'power2.inOut', stagger: 0.5 }, scrollTrigger: {
//       trigger: "#tori", pin: true, scrub: 0.3, start: "top 260%", end: "-=-3900", markers: false
//     }
//   });
...
//   var tl = gsap.timeline({
//     defaults: { duration: 3, ease: 'power2.inOut', stagger: 0.5 }, scrollTrigger: {
//       trigger: "#yuzuru", pin: true, scrub: 0.3, start: "top 370%", end: "-=-5200", markers: false
//     }
//   });
